...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('userbackend/panel/assets/images/logo.png') }}" >
        <!--Page title-->
        ...
        <div class="wrapper">
            ...
            <header class="header_area">
                ...
                <div class="sidebar_logo">
                    <a href="index.html">
                        <img src="{{ asset('userbackend/panel/assets/images/logo.png') }}" width="75px" height="75px" alt="" class="img-fluid logo1">
