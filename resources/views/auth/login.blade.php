...
<head>
  <meta charset="utf-8">
    ...
    <title>Jayawardena Network(Pvt)Ltd - Log in </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-5 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Jayawardena Network (Pvt) Ltd</h2>
                            ...
                            <form method="POST" action="{{ isset($guard) ? url($guard.'/login') :
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="emali" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
